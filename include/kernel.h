...
#define TA_INT_MANAGE				0x10u	/* 管理内割り込み 高級言語（アセンブラなし）　*/
#define TA_INT_UNMANAGE_HLNG		0x20u	/* 管理外割り込み 高級言語　*/
#define TA_INT_UNMANAGE_ASM			0x30u	/* 管理外割り込み アセンブラ　*/
#define TA_INT_UNGROUPED			0x00u	/* 管理外割り込み UNGROUPED 高級言語 CPU Resumeなどに使用する*/
#define TA_INTMSK_INTATR			0xF0u	/* 割り込み属性 MASK */
#define TA_INTMSK_PRIORITY			0x0Fu	/* 割り込み優先順位 MASK (0-15) 0:high ... 15:low*/
