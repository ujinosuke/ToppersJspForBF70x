/* Configured with [sample1_pp.cfg ] */
...
JSP_KERNEL_CFG_DATA SEMCB _kernel_semcb_table[TNUM_SEMID];
...
const INHINIB _kernel_inhinib_table[TNUM_INHNO] = {
	...
	{52,143,(FP)CFG_INT_ENTRY(sio1_tx_handler)},
	{53,143,(FP)CFG_INT_ENTRY(sio1_rx_handler)}
};
